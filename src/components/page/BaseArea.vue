	...
	<div class="table">
		...
		<el-dialog title="编辑" :visible.sync="editVisible" width="580px">
			<el-form ref="form" :model="form" :rules="rules" label-width="100px">
				...
				<el-upload action="" list-type="picture-card" :auto-upload="true" :before-upload="beforeUploadImage" name="file" :http-request="uploadImg"
...
export default {
  ...
  methods: {
    ...
    getData() {
      ...
      this.url =
        this.apiUrl +
        "/g01jfsc_zk65m/area/getAreaList?index=" +
        this.cur_page +
        "&page_size=" +
        this.pageSize;
    ...
    delAll() {
      ...
      if (length == 0) {
        ...
        this.$axios
          .post(this.apiUrl + "/g01jfsc_zk65m/area/deleteArea", {
    ...
    saveEdit(formName) {
      this.$refs[formName].validate(valid => {
        if (valid) {
          this.$axios
            .put(this.apiUrl + "/g01jfsc_zk65m/area/updateArea", {
    ...
    saveAdd(formName) {
      this.$refs[formName].validate(valid => {
        if (valid) {
          this.$axios
            .post(this.apiUrl + "/g01jfsc_zk65m/area/addArea", {
